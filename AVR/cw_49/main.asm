...
_timer_isr:
    ...
    ldi YL, 0x02
    ldi YH, 0x00           //set divider to 2

    rcall Divide           //modulo 1000 with results in R16, R17

    mov R16, R18
    mov R17, R19           //get number of ticks divided by two (cause two pulse edges)
...
_main:
    ...
    //INT0 PB0 pin interrupt enable
    ldi R18, 0b00000010 //any logical change of INT0 generates interrupt
    out MCUCR, R18

    ldi R18, 0b00100000 //PCIE 0 int enable
    out GIMSK, R18

    ldi R18, 0b00000001 //PCINT0 enable
    out PCMSK0, R18
